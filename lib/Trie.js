...
export default class Trie {
  ...
  suggest(entry) {
    ...
    // let suggestedWord = '';
    // // let nodeKey = Object.keys(currentNode)[0];
    // let i = 0
    // while(currentNode.children) {
    //   console.log(Object.values(currentNode.children));
    //   if(currentNode.children[entryArray[i]]) {
    //     suggestedWord = suggestedWord + nodeKey;
    //   }
